...
import { ref } from 'vue'
import CaretSortIcon from '@/components/icons/CaretSortIcon.vue'
  ...
  <Dialog v-model:open="showNewTeamDialog">
    <Popover v-model:open="open">
      ...
      <PopoverContent class="w-[200px] p-0">
        <Command :filter-function="(list: Array<{ label: string, value: string }>, term: string) => list.filter(i => i.label?.toLowerCase()?.includes(term)) ">
          <CommandList>
