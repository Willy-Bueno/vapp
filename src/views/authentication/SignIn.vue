    ...
    <div class="flex flex-col space-y-3 bg-gray-50 px-4 py-8 sm:px-16">
      ...
      <div class="relative">
        ...
        <div class="relative flex justify-center text-xs uppercase">
          <span class="bg-gray-50 px-2 text-muted-foreground"> Ou continue com </span>
        </div>
      </div>
      <form @submit="onSubmit" class="space-y-4">
        ...
        <div class="w-full flex justify-between">
          <Button type="button" variant="link" class="text-sm px-0" @click="$router.push({ name: 'forgot-password' })"> Esqueceu sua senha? </Button>
      ...
      <p class="text-center text-sm text-gray-500">
        ...
        <a href="/auth/register" class="font-semibold text-gray-500 transition-colors hover:text-black"> Cadastre-se </a>
        .
      </p>
    </div>
  </AuthWrapper>
